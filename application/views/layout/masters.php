      ...
      <nav id="navigation" class="navigation navigation-landscape">
        ...
        <div class="nav-menus-wrapper" style="transition-property: none;"><span class="nav-menus-wrapper-close-button">✕</span>
          <ul class="nav-menu nav-menu-social align-to-right">
            ...
            <li><a href="<?=site_url('/')?>#">Tentang Kami<span class="submenu-indicator"></span></a>
              <ul class="nav-dropdown nav-submenu" style="right: auto;">
                <li>
                  <a href="<?=site_url('/')?>sambutan">
                    Sambutan
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="<?=site_url('/')?>struktur">
                    Struktur Organisasi
                  </a>
                </li>
                <li>
                  <a href="<?=site_url('/')?>sk_team">
                    SK TIM
                  </a>
                </li>
                <li>
              ...
              <a href="<?=site_url('/')?>#">
                ...
                <ul class="nav-dropdown nav-submenu" style="right: auto;">
                  <li>
                    ...
                    <li>
                      <a href="<?=site_url('/')?>relaas">
                        Relaas Pengadilan
                      </a>
                    </li>
                    <li>
                      <a href="<?=site_url('/')?>penanganan">
                        Penanganan Perkara
                      </a>
                    </li>
                    <li>
                      <a href="<?=site_url('/')?>notaris">
                        Notaris
                      </a>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul class="nav-dropdown nav-submenu" style="right: 0px;">
                    <li>
                      <a href="<?=site_url('/')?>berita/4">
                        Artikel
                      </a>
                    </li>
                    <li>
                      <a href="<?=site_url('/')?>berita/1">
                        Berita
                      </a>
                    </li>
                    <li>
                      <a href="<?=site_url('/')?>berita/5">
                        Pengumuman
                      </a>
                    </li>
                    <li>

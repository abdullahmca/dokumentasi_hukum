        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <form style="padding: 15px;" action="<?= $action; ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
                        <div class="row">
                            <label class="col-md-2" for="character varying">User</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="user" id="user" placeholder="User" value="<?= $user; ?>" />
                                <?= form_error('user') ?>
                            </div>
                        </div>
                    </div>
					...
					<div class="form-group">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2">
                                ...
                                <a href="<?= site_url('user2') ?>" class="btn btn-danger"><i class="fa fa-sign-out"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
				</form>

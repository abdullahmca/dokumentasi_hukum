...
<html lang="zxx" data-uw-w-loader="" style="height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> 
  <meta name="author" content="Cilacap">
  ...
  <link href="<?=site_url('./assets/')?>v3/stylesv2.css" rel="stylesheet">
  <link href="<?=site_url('./assets/')?>v3/chatsv1a.css" rel="stylesheet" />
  <link rel="stylesheet" href="<?=site_url('./assets/')?>v3/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?=site_url('./assets/')?>v3/responsive.bootstrap4.min.css">
...
<!-- Aplikasi -->
<section class="space gray" style="margin-top:1%">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="sec_title position-relative text-center mb-5">
                    <h2 class="ft-bold">
                        JDIH
                        <!-- <span class="theme-cl">Daerah</span> -->
                    </h2>
                    <h6 class="text-muted mb-0"><br>
                        Jaringan Informasi Dokumentasi Hukum 
                    </h6>
                </div>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"> 
              <form action="<?=site_url('cari_dokumen')?>" method="post">
              <label class="col-md-10">
              <input  type="text" name="cari" class="form-control text_cari">
              </label>
              <input type="submit" name="submit" value="Cari" class="col-md-1 btn btn-primary button">
            </form>
            </div>
        </div>
                ...
                <div class="row align-items-center">  
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="<?=site_url('uu')?>" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle"> 
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="<?=site_url('perpres')?>" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle"> 
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="<?=site_url('perda')?>" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle"> 
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="perbup" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="kepbup" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="monografi" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="yurisprudensi" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>pembidangan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="artikel" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>hiring.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                                    <h4 class="fs-md mb-0 ft-medium m-catrio">
                                        <p>Artikel Hukum</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="bukuhukum" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>perpustakaan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                                    <h4 class="fs-md mb-0 ft-medium m-catrio">
                                        <p>Buku Hukum</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3" style="display:none;">
                        <div class="cats-wrap text-center">
                            <a href="https://jdih.sukoharjokab.go.id/ebook" class="cats-box d-block rounded bg-white px-2 py-4" target="_blank">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>ebook.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                                    <h4 class="fs-md mb-0 ft-medium m-catrio">
                                        <p>E-BOOK</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3" style="display:none;">
                        <div class="cats-wrap text-center">
                            <a href="https://jdih.sukoharjokab.go.id/hiring" class="cats-box d-block rounded bg-white px-2 py-4" target="_blank">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>hiring.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                          <!-- https://jdih.sukoharjokab.go.id/perpustakaan/buku -->
                            <a href="<?=site_url('perpustakaan')?>" class="cats-box d-block rounded bg-white px-2 py-4" target="_blank">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>perpustakaan.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                        <div class="cats-wrap text-center">
                            <a href="<?=site_url('anggota')?>" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>anggota.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                                    <h4 class="fs-md mb-0 ft-medium m-catrio">
                                        <p>ANGGOTA</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3" style="display:none;">
                        <div class="cats-wrap text-center">
                            <a href="bukutamu" class="cats-box d-block rounded bg-white px-2 py-4" target="_blank">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>bukutamu.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                                    <h4 class="fs-md mb-0 ft-medium m-catrio">
                                        <p>BUKU TAMU</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3" style="display:none;">
                        <div class="cats-wrap text-center">
                            <a href="https://jdih.sukoharjokab.go.id/#" data-toggle="modal" data-target="#bahasa" class="cats-box d-block rounded bg-white px-2 py-4">
                                <div class="text-center mb-2 mx-auto position-relative d-inline-flex align-items-center justify-content-center p-3 theme-bg-light circle">
                                    <img src="<?=site_url('./assets/v3/')?>bahasa.png" class="img-fluid circle" width="65" alt="">
                                </div>
                                <div class="cats-box-caption">
                                    <h4 class="fs-md mb-0 ft-medium m-catrio">
                                        <p>BAHASA</p>
    ...
    <script src="<?=site_url('./assets/')?>v3/jquery.min.js"></script>
    <script src="<?=site_url('./assets/')?>v3/bootstrap.min.js"></script>
    <script src="<?=site_url('./assets/')?>v3/jquery.dataTables.min.js"></script>
    <script src="<?=site_url('./assets/')?>v3/dataTables.bootstrap4.min.js"></script>
    <script src="<?=site_url('./assets/')?>v3/dataTables.responsive.min.js"></script>
    <script src="<?=site_url('./assets/')?>v3/responsive.bootstrap4.min.js"></script>
    <!-- 
